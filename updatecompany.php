...
<label for="company_id">Избери музикална компания: </label> <select name="company_name" required> <option selected disabled>---Избери---</option>
<?php
include "config.php";
...
Редактирай музикална компания:<input type="text" name="company"/><br><br>
